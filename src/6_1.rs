...
fn calc_button_pressing_range_length(time_dist_pair: (&u32, &u32)) -> u32 {
    ...
    let start_range = start_range_float.ceil() as u32;
    let end_range = end_range_float.floor() as u32;
